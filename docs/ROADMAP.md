...
local typed appliance state + portable backup (#3, done / v0.2.0)
        ↓
managed XKeen / Xray / geodata lifecycle (#4, active; trial beta.2 VERIFIED BETA; #64 correction delivered; F3 delivered by PR #67; #46 A-C delivered by PRs #69/#71 and this Draft PR, D next, then E-F; D.2 G and one feature-complete candidate afterward)
        ↓
...
## D.2 / Issue #4 — active; trial beta.2 VERIFIED BETA; #64 correction delivered; F3 delivered; #46 A-C delivered, D next
